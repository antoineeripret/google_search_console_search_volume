function get_keywords() {
  ...
  async function addVolumes() {
      const selected_tab = document.getElementsByClassName('mrslJ ZjAUM  nkLxl')[0].querySelectorAll('[aria-selected="true"]')[0].innerText;
      const first_tab = document.getElementsByClassName('mrslJ ZjAUM  nkLxl')[0].children[0].innerText;
      if (selected_tab === first_tab){
